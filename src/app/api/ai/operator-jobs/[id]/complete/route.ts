...
import { finalizeCopilotOperatorJob } from "@/lib/admin-copilot/service";
...
export async function POST(
  ...
  const response = await finalizeCopilotOperatorJob({
    jobId: id,
    outcome: "completed",
    decidedBy: admin.id,
    decidedByEmail: "email" in admin ? admin.email : null,
